      ...
      <Centered>
        <div className="consent bp3-ui-text">
          ...
          <p>
            ...
            (Cornell University). This study takes approximately 25-35 minutes
          ...
          <p>
            ...
            Prolific (recruitment), Empirica (game lobby), and AWS (hosting),
          ...
          <p>
            There are 3 phases, 70 rounds in the game. You will earn a $7.00
            base pay for completing the entire game and $0.03 bonus for each
            correct answer. Bonus starts from the first phase of the game. An
            extra $1 bonus will be paid if you cannot get paired at the
            beginning of phase 2. The pairing happens in real time, so try to
            start the game as soon as you accepted the submission before the
            game gets full!
          </p>
          ...
          <p>
            ...
            <a href="http://www.hotline.cornell.edu">www.hotline.cornell.edu</a>{" "}
            or by calling toll free at 1-866-293-3077. Ethicspoint is an
            independent organization that serves as a liaison between the
            University and the person bringing the complaint so that anonymity
            can be ensured.
          </p>
