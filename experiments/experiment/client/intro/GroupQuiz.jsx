            ...
            <div className="bp3-form-group">
              <div className="bp3-form-content">
                <RadioGroup
                  label={
                    <strong>
                      3. How do the speaker and the listener communicate in the
                      interactive game?
                    </strong>
                  }
                  onChange={this.handleRadioChange}
                ...
                >
                  ...
                  <Radio
                    label="Only the speaker can send messages."
                    value="speaker"
                  />
                  <Radio label="Neither can send messages." value="neither" />
                </RadioGroup>
              </div>
            </div>
            <div className="bp3-form-group">
              <div className="bp3-form-content">
                <RadioGroup
                  label={<strong>4. How do you know what your role is?</strong>}
                  onChange={this.handleRadioChange}
                ...
                >
                  <Radio
                    label="If you get speaker in the first round, you will be the speaker for the rest of the experiment."
                    value="alwaysSpeaker"
                  />
                  <Radio
