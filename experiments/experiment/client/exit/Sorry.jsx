      ...
      <Centered>
        <div className="score">
          ...
          <p>
            Please{" "}
            <a
              href={"https://app.prolific.co/submissions/complete?cc=C1HYBH1Z"}
            >
              click here
            </a>{" "}
            and you will be asked to return the submission. Please do so and we
            will compensate you with $1 for your time today plus bonus if you
            have started Phase 1.
          </p>
