// /** Phase 3 is the same as Phase 1

// Lines to change:
// 1. static stepName = "Phase3"; (before constructor)

// 2. this.props.onNext() // * 2 places
// this.props.onSubmit({});

// 3. change all "phase1" to "phase3"

// 4. import TangramSVG from "../intro/TangramSVG";
// import trialsConfig from "../intro/phase_data.json";
// import svgData from "../intro/tangrams.json";

// 5. add game.treatment to all treatment
// */

// import React from "react";
// import TangramSVG from "../intro/TangramSVG";
// import trialsConfig from "../intro/phase_data.json";
// import svgData from "../intro/tangrams.json";
// import Timer from "../game/Timer";
// import { Breadcrumb as Crumb, Classes } from "@blueprintjs/core";

// export default class Phase3 extends React.Component {
//   static stepName = "Phase3";
//   constructor(props) {
//     super(props);
//     this.state = {
//       activeButton: false,
//       currentTrial: this.props.player.data.phase3
//         ? this.props.player.data.phase3.length
//         : 0,
//       tangramsToRender: [],
//       comment: "",
//       remainingSeconds: 45,
//       firstKeyPress: -1,
//       trials: trialsConfig[props.game.treatment.configIndex]["trials"]["phase2"], // NOTE: json typo, phase2 is actually phase3
//     };
//   }
...
//                   <p>{"Earn up to $.... Bonus will be determined later."}</p>
//                 </div>
//               </div>
//               {/********* Chatlog **********/}
...
//                       <strong>Instruction (phase 3):</strong> Similar to phase
//                       1, please describe the tangram highlighted by black
//                       borders. <br />
//                       Your description should allow someone to pick the
